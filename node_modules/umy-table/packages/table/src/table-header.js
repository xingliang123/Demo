import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'umy-table/tools/utils/dom';
...
export default {
              ...
              >
                {
                  columns.map((column, cellIndex) => (<th
                   ...
                   {/*修改源码 添加拖动图标*/}
                    {
                      this.$parent.headerDragStyle && column.borderLine
                        ? <span class={!column.resizable ? 'pltableDragIcon': 'pltableDragIconHover pltableDragIcon'}> <i></i> </span>
                    : ''
                    }
                  {/*修改源码 当列的宽度小于内容了，不要换行显示，超出就省略符合 所以添加了个类pl-table-beyond*/}
                    <div
                       title={[column.label && this.$parent.showHeaderOverflow === 'title' ? column.label : '']}
                       class={[
                       'cell',
                       this.$parent.showHeaderOverflow ? 'umy-table-beyond' : '',
  ...
  methods: {
    ...
    getHeaderCellClass(rowIndex, columnIndex, row, column) {
      ...
      // 修改源码头部右边的边框线
      if (this.$parent.headerDragStyle) {
          classes.push('umy-table-header-border-right-none-th');
      }
