...
var cachedGlobalsInBrowser = _globals.globalsInBrowser.concat(process.env.NODE_ENV === 'test' ? ['mockNativeWindowFunction'] : []).reduce(function (acc, key) {
  return (0, _objectSpread5.default)((0, _objectSpread5.default)({}, acc), {}, (0, _defineProperty2.default)({}, key, true));
}, Object.create(null));
...
var cachedGlobalObjects = cachedGlobals.reduce(function (acc, globalProp) {
  return (0, _objectSpread5.default)((0, _objectSpread5.default)({}, acc), {}, (0, _defineProperty2.default)({}, globalProp, true));
}, {});
/*
