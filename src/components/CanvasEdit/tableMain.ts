...
export function windowOnload() {
  ...
  // 1. 初始化编辑器
  const container = document.querySelector<HTMLDivElement>('.editor-table')!
  containerExport = container
...
export { containerExport, instanceExport, recoveryTableFun }