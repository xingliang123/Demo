            ...
            <div id="middle" class="container">
                ...
                <div class="account-form">
                    <div class="account-form-group has-error">
                        ...
                        <input type="text" name="txtuserName" class="account-form-control js-input-name"  v-model.trim="name"  autocomplete="off"  maxlength="20" placeholder="用户名或手机号">
                    </div>
                    <div class="account-form-group has-error">
                        <!--下面这行是为了避免chrome自动填充，触发focus和blur事件-->
                    ...
                    <div class="account-form-group button-row">
                        ...
                        <div href="javascript:void(0)" class="account-form-btn js-btn-login" @click="submit">登录</div>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods:{
          ...
          async   submit (){
                ...
                const ret = await this.$http.post('/u/ajax/loginVerify',
                    this.$qs.stringify({"userName":userName, "password":password, "code":"", "callback":"123","clientId":"0","platform":0 }),
                    )
                    .then(res => {
                        return res.data;
                    }).catch(res=> {
